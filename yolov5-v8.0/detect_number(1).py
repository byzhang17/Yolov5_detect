...
detect_api_1 = detect.DetectAPI(weights='D:/yolov5-v7.0/runs/train/exp17/weights/best.pt', save_crop=True)
detect_api_2 = detect.DetectAPI(weights='D:/yolov5-v7.0/runs/train/exp20/weights/best.pt')
